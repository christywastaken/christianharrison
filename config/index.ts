...
export const blogPostItems: BlogPostItem[] = [
  { title:"This Website", about:`- This website serves as both a learning experience and a portfolio to showcase my learning.<br/><br/>- I'm trying to work with many different bits of tech. Building web apps has been a great help in broadening my base knowldege.<br/><br/>- This website is universally rendered using the Nuxt3 framework and deployed on Vercel (wow, that was easy!)`, link:"https://github.com/christywastaken/christianharrison", image: "/blog_post_images/christianharrison.png" },
